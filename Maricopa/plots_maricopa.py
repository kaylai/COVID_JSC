...
# determine outliers
q_low = maricopa_data["Daily_Confirmed"].quantile(0.01)
q_hi  = maricopa_data["Daily_Confirmed"].quantile(0.99)
df_filtered = maricopa_data[(maricopa_data["Daily_Confirmed"] < q_hi) & (maricopa_data["Daily_Confirmed"] > q_low)]
...
if df_filtered.Daily_Confirmed.max() > maricopa_data.Confirmed_Moving.max():
	my_y_max = df_filtered.Daily_Confirmed.max()
else:
	my_y_max = maricopa_data.Confirmed_Moving.max() + 100
